...
function toggleSkills() {
  ...
  if (itemClass === "skills__content skills__close") {
    ...
    const elementPosition =
      this.parentNode.getBoundingClientRect().top + window.pageYOffset;
